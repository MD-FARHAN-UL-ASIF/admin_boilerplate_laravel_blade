...
<head>
    ...
    <title>Wise Corporation</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
            <link rel="stylesheet" href="{{ url ('front/assets/fonts/ANSI V1/Li Alinur Tumatul ANSI V1 Italic.ttf') }}">

    <link rel="stylesheet" href="{{ url ('front/styles/style.css') }}">
        <link rel="stylesheet" href="{{ url ('front/styles/project_profile.css') }}">
            <link rel="stylesheet" href="{{ url ('front/styles/categories.css') }}">
                <link rel="stylesheet" href="{{ url ('front/styles/service.css') }}">
...
<body>
    ...
    @include('wise_corporation.layout.header')
    @yield('content')
    @include('wise_corporation.layout.footer')
    ...
    <script type="text/javascript">
        $('.carousel').slick({
            ...
            autoplay: true,
            autoplaySpeed: 3000,
            prevArrow: '<ion-icon class="prevArrow" name="chevron-back-circle"></ion-icon>',
            nextArrow: '<ion-icon class="nextArrow" name="chevron-forward-circle"></ion-icon>',
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
